...
/**
 * Operation payload for notification of alias timeline split.
 * Author: Michael Barall 07/19/2018.
 */
public class OpAliasSplit extends DBPayload {
	...
	private static final int MARSHAL_VER_1 = 37001;

	private static final String M_VERSION_NAME = "OpAliasSplit";
	...
	@Override
	public OpAliasSplit unmarshal (MarshalReader reader, String name) {
	...
	@Override
	public OpAliasSplit unmarshal_task (PendingTask ptask) {
		try {
