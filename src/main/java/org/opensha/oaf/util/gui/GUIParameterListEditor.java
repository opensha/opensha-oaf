...
// Editor class for a parameter list.
// Author: Michael Barall.
//
// This code is copied and then modified from the OpenSHA class ParameterListEditor.
//
...
public class GUIParameterListEditor extends GUILabeledBoxPanel {
	...
	protected final static String C = "GUIParameterListEditor";
	...
	public GUIParameterListEditor() {
		super();
		this.setLayout(new GridBagLayout());
	}

	/**
	 * Constructor for the GUIParameterListEditor object, calls
	 ...
	 */
	public GUIParameterListEditor(ParameterList paramList) {
	...
	/** Calls super() to configure the GUI */
	public GUIParameterListEditor(GUIHelpListener helpListener) {
		super(helpListener);
		this.setLayout(new GridBagLayout());
	}
	 ...
	 * to the GUI in a scrolling list. <p>
	 */
	public GUIParameterListEditor(ParameterList paramList, GUIHelpListener helpListener) {
	...
	public final void setParameterList( ParameterList paramList ) {
	...
	/**
	 *  Gets the parameterEditor attribute of the GUIParameterListEditor object
	 *
	 ...
	 */
	protected final void addParameters() {
