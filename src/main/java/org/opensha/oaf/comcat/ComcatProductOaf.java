 ...
 */
public class ComcatProductOaf extends ComcatProduct {
	...
	public static ComcatProductOaf make_from_gj (JSONObject gj_product) {
		return make_from_gj (gj_product, false);
	}

	public static ComcatProductOaf make_from_gj (JSONObject gj_product, boolean delete_ok) {
		ComcatProductOaf the_product = new ComcatProductOaf();
	...
	public static ComcatProductOaf make_preferred_from_gj (JSONObject event) {
		return make_preferred_from_gj (event, false);
	}

	public static ComcatProductOaf make_preferred_from_gj (JSONObject event, boolean delete_ok) {
		int index = 0;
	...
	public static List<ComcatProductOaf> make_list_from_gj (JSONObject event) {
		return make_list_from_gj (event, false);
	}

	public static List<ComcatProductOaf> make_list_from_gj (JSONObject event, boolean delete_ok) {
		ArrayList<ComcatProductOaf> the_product_list = new ArrayList<ComcatProductOaf>();
		...
		if (gj_product_array != null) {
			...
			for (int k = 0; k < gj_product_array.size(); ++k) {
				...
				if (gj_product != null) {
					ComcatProductOaf the_product = make_from_gj (gj_product, delete_ok);
	...
	public static void main(String[] args) {
		...
		if (args.length < 1) {
			System.err.println ("ComcatProductOaf : Missing subcommand");
			return;
		}
		...
		if (args[0].equalsIgnoreCase ("test1")) {
			...
			if (args.length != 4 && args.length != 5) {
				System.err.println ("ComcatProductOaf : Invalid 'test1' subcommand");
				return;
			}
		...
		if (args[0].equalsIgnoreCase ("test2")) {
			...
			if (args.length != 6 && args.length != 7) {
				System.err.println ("ComcatProductOaf : Invalid 'test2' subcommand");
				return;
			}
		...
		if (args[0].equalsIgnoreCase ("test3")) {
			...
			if (args.length != 5 && args.length != 6) {
				System.err.println ("ComcatProductOaf : Invalid 'test3' subcommand");
				return;
			}
		...
		if (args[0].equalsIgnoreCase ("test4")) {
			...
			if (args.length != 4 && args.length != 5) {
				System.err.println ("ComcatProductOaf : Invalid 'test4' subcommand");
				return;
			}
		...
		System.err.println ("ComcatProductOaf : Unrecognized subcommand : " + args[0]);
		return;
