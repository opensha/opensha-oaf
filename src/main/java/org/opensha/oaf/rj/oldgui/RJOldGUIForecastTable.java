...
public class RJOldGUIForecastTable extends RJOldGUIListener {
	...
	public RJOldGUIForecastTable (RJOldGUIComponent gui_comp, USGS_AftershockForecast forecast, String my_name) throws GUIEDTException {
