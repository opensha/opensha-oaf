...
public class RJGUIView extends RJGUIComponent {
...
//			size *= sizeMult;
	...
	private void plotAftershockHypocs() {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotAftershockHypocs, tab count = " + tabbedPane.getTabCount());
		}
	...
	private void plotMFDs (IncrementalMagFreqDist mfd, double mmaxc) throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotMFDs, tab count = " + tabbedPane.getTabCount());
		}

		if (!( gui_model.modstate_has_catalog() )) {
			throw new IllegalStateException ("RJGUIView.plotMFDs - Invalid model state: " + gui_model.cur_modstate_string());
		}
...
//			funcs.add(gr);
	...
	private void plotMagVsTime() throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotMagVsTime, tab count = " + tabbedPane.getTabCount());
		}
	...
	private void plotCumulativeNum () throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotCumulativeNum, tab count = " + tabbedPane.getTabCount());
		}

		if (!( gui_model.modstate_has_catalog() )) {
			throw new IllegalStateException ("RJGUIView.plotCumulativeNum - Invalid model state: " + gui_model.cur_modstate_string());
		}
...
//		magTimeGraph.setY_AxisRange(Math.max(0, magTrack.getMin()-1d), magTrack.getMax()+1d);
	...
	private void plotCatalogText() throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotCatalogText, tab count = " + tabbedPane.getTabCount());
		}

		if (!( gui_model.modstate_has_catalog() )) {
			throw new IllegalStateException ("RJGUIView.plotCatalogText - Invalid model state: " + gui_model.cur_modstate_string());
		}
	...
	private void plotPDFs() throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotPDFs, tab count = " + tabbedPane.getTabCount());
		}

		if (!( gui_model.modstate_has_aftershock_params() )) {
			throw new IllegalStateException ("RJGUIView.plotPDFs - Invalid model state: " + gui_model.cur_modstate_string());
		}
	...
	public void precomputeEAMFD (GUICalcProgressBar progress, double minDays, double maxDays) {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.precomputeEAMFD");
		}
	...
	private void plotEAMFD() throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotEAMFD, tab count = " + tabbedPane.getTabCount());
		}

		if (!( gui_model.modstate_has_forecast() )) {
			throw new IllegalStateException ("RJGUIView.plotEAMFD - Invalid model state: " + gui_model.cur_modstate_string());
		}
	...
	private void plotAFTable() throws GUIEDTException {
		...
		if (gui_top.get_trace_events()) {
			System.out.println ("@@@@@ Entry: RJGUIView.plotAFTable, tab count = " + tabbedPane.getTabCount());
		}

		if (!( gui_model.modstate_has_forecast() )) {
			throw new IllegalStateException ("RJGUIView.plotAFTable - Invalid model state: " + gui_model.cur_modstate_string());
		}
		...
		for (int i=0; i<aft_models.size(); i++) {
			...
			forecastTablePane.addTab(name, (new RJGUIForecastTable(this, forecast, name)).get_my_panel());
		}
