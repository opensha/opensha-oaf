...
public class OEGaussAPCConfig {
	...
	public final List<OEGaussAPCParams> get_parameter_list () {
	...
	public final String get_params_version () {
		return OEGaussAPCParams.get_embedded_csv_version();
	}
	...
	public static void main(String[] args) {
		try {
		TestArgs testargs = new TestArgs (args, "OEGaussAPCConfig");
		...
		if (testargs.is_test ("test3")) {
			...
			int n = 0;
			for (OEGaussAPCParams value : gauss_apc_config.get_parameter_list()) {
