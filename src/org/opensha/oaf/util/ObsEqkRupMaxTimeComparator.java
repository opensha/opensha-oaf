...
/**
 * Comparator to sort ruptures in decreasing order by time (latest rupture first).
 ...
 */
public class ObsEqkRupMaxTimeComparator implements Comparator<ObsEqkRupture> {
	...
	public int compare (ObsEqkRupture rupEvent1, ObsEqkRupture rupEvent2) {
		...
		int result = Long.compare (rupEvent2.getOriginTime(), rupEvent1.getOriginTime());
