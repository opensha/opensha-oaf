...
public class RJOldGUIComponent {

	//----- Linkage -----

	// The top-level window.

	protected RJOldGUITop gui_top;

	// The model.

	protected RJOldGUIModel gui_model;

	// The view.

	protected RJOldGUIView gui_view;

	// The controller.

	protected RJOldGUIController gui_controller;
	...
	public void link_components (RJOldGUIComponent other) {
