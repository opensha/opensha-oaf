...
public class RJGUIModel extends RJGUIComponent {
	...
	public final boolean advance_modstate (int new_modstate) throws GUIEDTException {
		...
		if (!( new_modstate >= MODSTATE_MIN && new_modstate <= MODSTATE_MAX )) {
			throw new IllegalArgumentException ("RJGUIModel.advance_modstate - Invalid new model state: " + get_modstate_as_string(new_modstate));
		}

		// Check for valid transition

		if (!( new_modstate >= modstate && new_modstate <= modstate + 1 )) {
			throw new IllegalStateException ("RJGUIModel.advance_modstate - Invalid model state transition: " + get_modstate_as_string(modstate) + " -> " + get_modstate_as_string(new_modstate));
		}
	...
	public final boolean retreat_modstate (int new_modstate) throws GUIEDTException {
		...
		if (!( new_modstate >= MODSTATE_MIN && new_modstate <= MODSTATE_MAX )) {
			throw new IllegalArgumentException ("RJGUIModel.retreat_modstate - Invalid new model state: " + get_modstate_as_string(new_modstate));
		}

		// Check for valid transition

		if (!( new_modstate <= modstate )) {
			throw new IllegalStateException ("RJGUIModel.retreat_modstate - Invalid model state transition: " + get_modstate_as_string(modstate) + " -> " + get_modstate_as_string(new_modstate));
		}
	...
	public final ObsEqkRupture get_cur_mainshock () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cur_mainshock while in state " + cur_modstate_string());
		}
	...
	public final ObsEqkRupList get_cur_aftershocks () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cur_aftershocks while in state " + cur_modstate_string());
		}
	...
	public final RJ_AftershockModel_SequenceSpecific get_cur_model () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cur_model while in state " + cur_modstate_string());
		}
		return cur_model;
	}
	...
	public final RJ_AftershockModel_Generic get_genericModel () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.genericModel while in state " + cur_modstate_string());
		}
		return genericModel;
	}
	...
	public final RJ_AftershockModel_Bayesian get_bayesianModel () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.bayesianModel while in state " + cur_modstate_string());
		}
	...
	public final IncrementalMagFreqDist get_aftershockMND () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.aftershockMND while in state " + cur_modstate_string());
		}
	...
	public final double get_mnd_mmaxc () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.mnd_mmaxc while in state " + cur_modstate_string());
		}
		return mnd_mmaxc;
	}
	...
	public final USGS_AftershockForecast get_genericForecast () {
		if (!( modstate >= MODSTATE_FORECAST )) {
			throw new IllegalStateException ("Access to RJGUIModel.genericForecast while in state " + cur_modstate_string());
		}
	...
	public final USGS_AftershockForecast get_seqSpecForecast () {
		if (!( modstate >= MODSTATE_FORECAST )) {
			throw new IllegalStateException ("Access to RJGUIModel.seqSpecForecast while in state " + cur_modstate_string());
		}
	...
	public final USGS_AftershockForecast get_bayesianForecast () {
		if (!( modstate >= MODSTATE_FORECAST )) {
			throw new IllegalStateException ("Access to RJGUIModel.bayesianForecast while in state " + cur_modstate_string());
		}
	...
	public final String get_cat_eventIDParam () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_eventIDParam while in state " + cur_modstate_string());
		}
	...
	public final double get_cat_dataStartTimeParam () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_dataStartTimeParam while in state " + cur_modstate_string());
		}
	...
	public final double get_cat_dataEndTimeParam () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_dataEndTimeParam while in state " + cur_modstate_string());
		}
	...
	public final double get_cat_mcParam () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_mcParam while in state " + cur_modstate_string());
		}
		return cat_mcParam;
	}
	...
	public final double get_cat_bParam () {
		if (!( modstate >= MODSTATE_CATALOG )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_bParam while in state " + cur_modstate_string());
		}
		return cat_bParam;
	}
	...
	public final double get_cat_forecastStartTimeParam () {
		if (!( modstate >= MODSTATE_FORECAST )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_forecastStartTimeParam while in state " + cur_modstate_string());
		}
	...
	public final double get_cat_forecastEndTimeParam () {
		if (!( modstate >= MODSTATE_FORECAST )) {
			throw new IllegalStateException ("Access to RJGUIModel.cat_forecastEndTimeParam while in state " + cur_modstate_string());
		}
...
//		System.out.println(formatter.format(Date.from (daybreak)));
	...
	private void postFetchActions (RJGUIController.XferCatalogMod xfer) {
