...
/**
 * Iterator for iterating through records in a table (collection), using Morphia.
 ...
 */
public class RecordIteratorMorphia<T> implements RecordIterator<T> {
	...
	public RecordIteratorMorphia (MorphiaIterator<T,T> morphia_iterator) {
